 ...
 * @param {Date} dt
 * @returns {string}
 */function format1(dt){var{year:dt,month:e,day:t,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(e)}-${zeroPad(t)}T${zeroPad(a)}:${zeroPad(n)}:${zeroPad(r)}Z`}
/**
 * @param {Date} dt
 * @returns {string}
 */function format2(dt){var{year:dt,month:e,day:t,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(e)}-${zeroPad(t)}T${zeroPad(a)}:${zeroPad(n)}:`+zeroPad(r)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format3(dt){var{year:dt,month:e,day:t,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(e)}-${zeroPad(t)} ${zeroPad(a)}:${zeroPad(n)}:`+zeroPad(r)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format4(dt){var{year:dt,month:e,day:t,hour:a,minute:n}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(e)}-${zeroPad(t)} ${zeroPad(a)}:`+zeroPad(n)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format5(dt){let{year:e,month:t,day:a,hour:n,minute:r,second:i}=breakDownDate(dt),o="AM";return 12<n&&(o="PM",n-=12),0===n&&(n=12),`${zeroPad(t)}/${zeroPad(a)}/${zeroPad(e)} ${zeroPad(n)}:${zeroPad(r)}:${zeroPad(i)} `+o}
/**
 * @param {Date} dt
 * @returns {string}
 */function format6(dt){let{year:e,month:t,day:a,hour:n,minute:r}=breakDownDate(dt),i="AM";return 12<n&&(i="PM",n-=12),0===n&&(n=12),`${zeroPad(t)}/${zeroPad(a)}/${zeroPad(e)} ${zeroPad(n)}:${zeroPad(r)} `+i}
/**
 * @param {Date} dt
 * @returns {string}
