 ...
 * @param {Date} dt
 * @returns {string}
 */function format1(dt){var{year:dt,month:t,day:e,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(t)}-${zeroPad(e)}T${zeroPad(a)}:${zeroPad(n)}:${zeroPad(r)}Z`}
/**
 * @param {Date} dt
 * @returns {string}
 */function format2(dt){var{year:dt,month:t,day:e,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(t)}-${zeroPad(e)}T${zeroPad(a)}:${zeroPad(n)}:`+zeroPad(r)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format3(dt){var{year:dt,month:t,day:e,hour:a,minute:n,second:r}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(t)}-${zeroPad(e)} ${zeroPad(a)}:${zeroPad(n)}:`+zeroPad(r)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format4(dt){var{year:dt,month:t,day:e,hour:a,minute:n}=breakDownDate(dt);return`${zeroPad(dt)}-${zeroPad(t)}-${zeroPad(e)} ${zeroPad(a)}:`+zeroPad(n)}
/**
 * @param {Date} dt
 * @returns {string}
 */function format5(dt){let{year:t,month:e,day:a,hour:n,minute:r,second:i}=breakDownDate(dt),o="AM";return 12<n&&(o="PM",n-=12),0===n&&(n=12),`${zeroPad(e)}/${zeroPad(a)}/${zeroPad(t)} ${zeroPad(n)}:${zeroPad(r)}:${zeroPad(i)} `+o}
/**
 * @param {Date} dt
 * @returns {string}
 */function format6(dt){let{year:t,month:e,day:a,hour:n,minute:r}=breakDownDate(dt),i="AM";return 12<n&&(i="PM",n-=12),0===n&&(n=12),`${zeroPad(e)}/${zeroPad(a)}/${zeroPad(t)} ${zeroPad(n)}:${zeroPad(r)} `+i}
/**
 * @param {Date} dt
 * @returns {string}
...
/(?<month>\d{2})\/(?<day>\d{2})\/(?<year>\d{4})/];for(let t=0;t<e.length;t++){var a=dt.match(e[t]);if(a){var n=parseInt(a.groups.year)||(new Date).getFullYear(),r=parseInt(a.groups.month)||(new Date).getMonth(),i=parseInt(a.groups.day)||(new Date).getDate();let t=parseInt(a.groups.hour)||0;var o=parseInt(a.groups.minute)||0,d=parseInt(a.groups.second)||0;let e=a.groups.meridian||"";return""!==e&&"pm"===e.toLowerCase()&&t<12&&(t+=12),new Date(n,r-1,i,t,o,d)}}throw new Error("no pattern match for "+dt)}
/**
