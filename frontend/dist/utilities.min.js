 ...
 * @returns {Map} A Map
 */
const objectToMap=(o={})=>{let e=new Map;for(const t in o)e.set(t,o[t]);return e},debounce=(fn,delay=400)=>{let t=null;return function(){let e=arguments;clearTimeout(t),t=setTimeout(()=>{fn.apply(this,e)},delay)}};
/**
